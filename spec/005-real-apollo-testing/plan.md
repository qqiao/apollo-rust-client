...
- **Verified Local Verification**:
  ...
  - **CI & Environmental Status**: Local macOS ARM64 (Apple Silicon) runs fully verified. GitHub Actions workflow (`.github/workflows/rust.yml`) configured with Node 24, preflight checks, job timeout, fallback teardown, and artifact uploads; Pull request created at [https://github.com/qqiao/apollo-rust-client/pull/132](https://github.com/qqiao/apollo-rust-client/pull/132); remote CI execution and Linux amd64 runner logs are tracked there.
